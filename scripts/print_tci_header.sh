 ...
 * \"<copied FWID>\" | xxd -r -p | xxd -i
 */
static const unsigned char tci_ekcert[] = {  0x8c, 0x95, 0x2f, 0x35, 0x52, 0x34, 0xe7, 0x8c, 0x79, 0x40, 0xb3, 0x0d,\
  0x62, 0x78, 0x55, 0x42, 0x1e, 0x10, 0x26, 0xd9, 0x7e, 0xc8, 0xf5, 0xaa,\
  0x0c, 0x51, 0x1d, 0x10, 0xb9, 0x48, 0x40, 0x92};"

sh scripts/print_header.sh "TCIs_H" "${CONTENT}"
